...
<div class="content-wrapper" style="background-image: url('{{ asset('/dist/img/product/'.$product->thumbnail) }}'); background-size: cover; background-position: center;">
        ...
        <div class="card-body">
            <table class="table table-hover table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <td>
                    <img class="img-fluid" 
                        src="{{ asset('/dist/img/product/'.$product->thumbnail) }}"
                        alt="hinh.png" 
                        style="width: 150px; height: 150px; border: 2px solid #696969;border-radius: 15px;" />
                    </td>
                    <td>{{ $product->name }}</td>
