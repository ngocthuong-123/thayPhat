        ...
        <div class="container">
            ...
            <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" class="form-control" id="pricebuy" name="pricebuy" required>
                </div>
                <!-- Product Pricesale -->
                <div class="form-group">
                    <label for="pricesale">Giá khuyến mãi</label>
                    <input type="number" step="0.01" class="form-control" id="pricesale" name="pricesale" required>
                </div>
                <!-- Product Pricesale -->
                <div class="form-group">
